...
<body>
    <div class="header">
        <h1 class="title">LAPORAN: RISIKO KADALUARSA</h1>
    ...
    <table>
        <thead>
            <tr>
                <th>Tingkat Risiko</th><th>Total Nilai Kerugian (Rp)</th>
            </tr>
        </thead>
        <tbody>
            @forelse($tableData as $row)
            <tr>
                <td class="text-center">Kritis (< 30 Hari)</td><td>{{ number_format($tableData["criticalValue"], 0, ",", ".") }}</td></tr><tr><td class="text-center">Waspada (< 60 Hari)</td><td>{{ number_format($tableData["warningValue"], 0, ",", ".") }}</td>
            </tr>
            @empty
            <tr>
