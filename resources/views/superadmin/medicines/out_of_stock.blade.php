<x-superadmin-layout>
    ...
    @if(session('success'))
    <div class="mb-6 p-4 bg-green-50 border border-green-200 rounded-2xl flex items-start gap-3 slim-toast shadow-sm">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-green-600 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
        <div class="text-sm font-medium text-green-800 mt-0.5">{{ session('success') }}</div>
    </div>
    @endif
