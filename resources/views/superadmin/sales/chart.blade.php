<x-superadmin-layout>
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Grafik Penjualan</h1>
            <p class="text-slate-500 mt-1">Pantau performa pendapatan apotek setiap bulannya.</p>
        </div>
        
        <form method="GET" action="{{ route('superadmin.sales.chart') }}" id="yearForm" class="flex items-center gap-3">
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 md:p-8">
        <h3 class="text-lg font-bold text-slate-800 mb-6 border-b border-slate-100 pb-4">Statistik Penjualan Tahun {{ $year }}</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-6 border-t border-slate-100">
            <div class="p-5 rounded-2xl bg-brand-blue/5 border border-brand-blue/10 hover:shadow-md transition-shadow">
                <p class="text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Penjualan Terbanyak</p>
            ...
            <div class="p-5 rounded-2xl bg-red-50 border border-red-100 hover:shadow-md transition-shadow">
                <p class="text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Penjualan Tersedikit</p>
            ...
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="px-6 py-8 text-center text-slate-500 text-sm font-medium">Belum ada data penjualan obat di tahun ini.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
